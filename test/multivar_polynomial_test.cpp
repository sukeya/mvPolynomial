...
BOOST_AUTO_TEST_CASE(
    multivar_polynomial_derivative, *utf::tolerance(tt::fpc::percent_tolerance(1e-10))
) {
  auto ans = std::vector<std::pair<Eigen::Array2i, double>>();
  ans      = {
      {{0, 0}, 1},
...
BOOST_AUTO_TEST_CASE(
    multivar_polynomial_integral, *utf::tolerance(tt::fpc::percent_tolerance(1e-10))
) {
  auto ans = std::vector<std::pair<Eigen::Array2i, double>>();
  ans      = {
      {{0, 0}, 1},
...
BOOST_AUTO_TEST_CASE(
    multivar_polynomial_multiply, *utf::tolerance(tt::fpc::percent_tolerance(1e-10))
) {
  auto ans = std::vector<std::pair<Eigen::Array2i, double>>();
  ans      = {
      {{0, 0}, 1},
...
BOOST_AUTO_TEST_CASE(
    multivar_polynomial_default_value_check, *utf::tolerance(tt::fpc::percent_tolerance(1e-10))
) {
  auto ans = std::vector<std::pair<Eigen::Array2i, double>>();
  ans      = {
      {{0, 0}, 0},
...
BOOST_AUTO_TEST_CASE(
    multivar_polynomial_exact_of_init, *utf::tolerance(tt::fpc::percent_tolerance(1e-10))
) {
